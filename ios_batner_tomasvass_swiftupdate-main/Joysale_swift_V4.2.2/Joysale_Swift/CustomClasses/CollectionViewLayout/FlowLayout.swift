...
open class FlowLayout: UICollectionViewFlowLayout {
    ...
    override open func layoutAttributesForElements(in rect: CGRect) -> [UICollectionViewLayoutAttributes]? {
        ...
        guard let offset = collectionView?.contentOffset, let stLayoutAttributes = layoutAttributesObjects else {
...
fileprivate extension UICollectionViewLayoutAttributes {
    ...
    func isRepresentingFirstItemInLine(collectionViewLayout: FlowLayout) -> Bool {
        if currentItem <= 0 {
            return true
        }
        else {
    ...
    func isRepresentingLastItemInLine(collectionViewLayout: FlowLayout) -> Bool {
    ...
    private func alignToPrecedingItem(collectionViewLayout: FlowLayout) {
    ...
    ///
    /// - Parameter collectionViewLayout: The layout on which to perfom the calculations.
    private func alignToFollowingItem(collectionViewLayout: FlowLayout) {
        let itemSpacing = collectionViewLayout.minimumInteritemSpacing
    ...
    func alignHorizontally(collectionViewLayout: FlowLayout) {
    ...
    func alignVertically(collectionViewLayout: FlowLayout) {
