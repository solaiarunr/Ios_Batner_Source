...
class PremiumPromoVc: UIViewController {
    ...
    var adlistarr: [PromoPremium] = []      // API list
...
//        self.PlanView.isHidden = true
        ...
        navigationController?.customNavigationBarView(title: "PremiumFeatures",
                                                      fColor: "whitecolor",
    ...
    func loadData() {
        ...
        viewModel.getpremiumdata(
            ...
            onSuccess: { success in
                ...
                if success {
                    self.adlistarr = self.viewModel.premiumPromoModel?.PromoPremiumList ?? []
...
extension PremiumPromoVc: UITableViewDelegate, UITableViewDataSource {
